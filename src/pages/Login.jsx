      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="mt-8 relative">
          ...
          <div className="relative flex justify-center">
            <span className="px-4 bg-black text-[11px] text-white/20 tracking-[0.06em] uppercase">
              Student Certificate Portal
            </span>
          </div>
        </div>

        <Link to="/student-login" className="block mt-5">
          <div className="group flex items-center justify-between px-5 py-4 rounded-2xl border border-white/[0.07] bg-[#0c0c0c] hover:border-[#38bdf8]/30 hover:bg-[#38bdf8]/[0.03] transition-all duration-200 cursor-pointer">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-white/30">
                  Request certificates with Register No. &amp; DOB
                </p>
              </div>
            </div>
            <svg className="w-4 h-4 text-white/20 group-hover:text-[#38bdf8]/60 group-hover:translate-x-0.5 transition-all duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
